...
<body>
	...
	<div class="container" >
	<h2 class="text-success">Update User</h2>
	<f:form class="col-4" modelAttribute="user" action="/admin/addUser" method="post">
		...
		<f:label path="role">Role</f:label>
			<f:input path="role" class="form-control"/>
			<f:errors path="role" cssStyle="color:red"></f:errors>
		</div>
	...
	<hr>
	<a class="btn btn-info" href="/admin/users">Back to User List</a>
	</div>
